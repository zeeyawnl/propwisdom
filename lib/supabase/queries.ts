...
function mapDbPropertyToProperty(dbProp: any) {
  return {
    ...
    area: dbProp.area,
    variantBedrooms: dbProp.variant_bedrooms !== undefined ? dbProp.variant_bedrooms : dbProp.variantBedrooms,
    variantArea: dbProp.variant_area !== undefined ? dbProp.variant_area : dbProp.variantArea,
    variantBedrooms2: dbProp.variant_bedrooms_2 !== undefined ? dbProp.variant_bedrooms_2 : dbProp.variantBedrooms2,
    variantArea2: dbProp.variant_area_2 !== undefined ? dbProp.variant_area_2 : dbProp.variantArea2,
